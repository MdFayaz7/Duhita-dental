...
export default function ContactSection({ heading = 'Book Your Visit', eyebrow = 'Ready to take the next step?' }) {
  return (
    <section id="appointment" className="bg-mist section-y scroll-mt-24">
      <div className="container-x grid gap-8 lg:grid-cols-2 lg:gap-20 items-center">
        <div className="reveal">
          ...
          <ul className="mt-7 sm:mt-10 space-y-4 text-[15px] text-ink max-sm:[&_a]:inline-block max-sm:[&_a]:py-0.5">
        ...
        <div className="reveal card p-6 sm:p-10 md:p-14 text-center">
          ...
          <p className="mt-5 text-[15.5px] sm:text-[16px] leading-relaxed max-w-sm mx-auto">
            Choose a date and time that suits you — morning or evening, Monday to Saturday.
          </p>
          <Link to="/patients/book-appointment" className="btn btn-solid !px-9 !py-4 !text-[15px] mt-7 sm:mt-8 w-full sm:w-auto">Book an Appointment</Link>
        </div>
      </div>
    </section>
  );
